...
\usepackage{hyperref}
\hypersetup{
            pdftitle={Organizing Your Research Workflow with Rstudio},
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{results =}\StringTok{ }\KeywordTok{foreach}\NormalTok{(}\DataTypeTok{i =} \DecValTok{1}\OperatorTok{:}\NormalTok{Nsim) }\OperatorTok{%dorng%}\StringTok{ }\NormalTok{\{}
  \KeywordTok{thing_I_want_in_parallel}\NormalTok{()}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
