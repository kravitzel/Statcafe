...
Make a new dataset. The responses variables is $D_{i \ell}$ and the explanatory variables are $Z_i$. This means we have to repeat each $Z_i$ so there is a $Z_i$ for each $D_{i \ell}$. So our new data is $\{ (D_{11}, Z_1), (D_{12}, Z_1), \dots D_{1 m_1(m_1 - 1) }, Z_1), (D_{21}, Z_1), \dots ,(D_{n  m_n (m_n-1) }, Z_n) \}$. This notation is a mess, sorry.
